  ...
  <div class="max-w-md mx-auto mt-10 p-6 rounded shadow font-main text-MyWhite">
    ...
    <div class="mb-8">
      ...
      <div class="mb-4">
        ...
        <input v-model="artist" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Artist Name" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">Album</label>
        <input v-model="album" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Album Title" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">Release Year</label>
        <input v-model="year" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Year" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">RPM</label>
        <input v-model="rpm" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="33, 45, 78" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">Cover Image URL</label>
        <input v-model="coverImage" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 mb-2 font-main text-MyWhite placeholder-gray-400" placeholder="Cover Image URL" />
      ...
      <div class="mb-4">
        ...
        <input v-model="format" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="e.g. Vinyl, LP, Album, 12" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">Genre</label>
        <input v-model="genre" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Genre" />
      </div>
      <div class="mb-4">
        <label class="block mb-1 font-medium">Number of Records</label>
        <input v-model="numRecords" type="text" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Number of Records" />
      </div>
    </div>
    ...
    <div>
      ...
      <form @submit.prevent="onSubmit">
        <div class="mb-4">
          ...
          <input v-model.number="price" type="number" min="0" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Price" />
        </div>
        <div class="mb-4">
          <label class="block mb-1 font-medium">Discount (%)</label>
          <input v-model.number="discount" type="number" min="0" max="100" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Discount" />
        </div>
        <div class="mb-4">
          <label class="block mb-1 font-medium">Stock Quantity</label>
          <input v-model.number="stock" type="number" min="0" class="w-full border border-gray-500 bg-MyBlack rounded px-3 py-2 font-main text-MyWhite placeholder-gray-400" placeholder="Stock" />
        </div>
        <div class="mb-4">
